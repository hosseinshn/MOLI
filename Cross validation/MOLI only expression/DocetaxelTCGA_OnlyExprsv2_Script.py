...
save_results_to = '/home/hnoghabi/OnlyExprsv2/Docetaxel/'
...
#ls_mb_size = [15, 36, 70]
#ls_h_dim = [1024, 256, 128, 512, 64]
#ls_h_dim = [32, 16, 8, 4]
#ls_marg = [0.5, 2, 2.5, 3]
#ls_lr = [0.5, 0.1, 0.05, 0.01, 0.001, 0.005, 0.0005, 0.0001,0.00005, 0.00001]
#ls_lr1 = [0.01, 0.001, 0.005, 0.0005]
#ls_lr2 = [0.5, 0.1, 0.01, 0.001, 0.0005, 0.0001, 0.00005, 0.00001]
#ls_lr3 = [0.5, 0.1, 0.05, 0.01, 0.001, 0.005, 0.0001,0.00005, 0.00001]
#ls_lr4 = [0.1, 0.05, 0.005, 0.0005, 0.0001,0.00005, 0.00001]
#ls_epoch = [10, 20, 50]
#ls_rate = [0.3, 0.4, 0.5]
#ls_wd = [0.1, 0.001, 0.0001]
...
for iters in range(max_iter):
    ...
    for train_index, test_index in skf.split(GDSCE.values, Y):
        ...
        title = 'Cost Docetaxel iter = {}, fold = {}, mb_size = {},  h_dim = {}, marg = {}, lrE = {}, epoch = {}, rate = {}, wd = {}, lrCL = {}, lam = {}'.\
        ...
        title = 'AUC Docetaxel iter = {}, fold = {}, mb_size = {},  h_dim = {}, marg = {}, lrE = {}, epoch = {}, rate = {}, wd = {}, lrCL = {}, lam = {}'.\
                      format(iters, k, mbs, hdm, mrg, lre, epch, rate, wd, lrCL, lam)        
