...
save_results_to = '/home/hnoghabi/CVClassifierResultsv9/Paclitaxel/'
max_iter = 100
torch.manual_seed(42)

# Load Mutation
GDSCE = pd.read_csv("GDSC_exprs.Paclitaxel.eb_with.PDX_exprs.Paclitaxel.tsv", sep = "\t", index_col=0, decimal = ",")
GDSCE = pd.DataFrame.transpose(GDSCE)
# Load GDSC response
GDSCR = pd.read_csv("GDSC_response.Paclitaxel.tsv", sep = "\t", index_col=0, decimal = ",")
...
PDXR = pd.read_csv("PDX_response.Paclitaxel.tsv", sep = "\t", index_col=0, decimal = ",")
