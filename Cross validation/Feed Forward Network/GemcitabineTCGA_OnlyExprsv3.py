...
save_results_to = '/home/hnoghabi/OnlyExprsv3/GemcitabineTCGA/'
seed = 42
...
for iters in range(max_iter):
    ...
    for train_index, test_index in skf.split(GDSCE.values, Y):
        ...
        title = 'Cost Gemcitabine iter = {}, fold = {}, mb_size = {},  h_dim = {},lrE = {}, epoch = {}, rate = {}, wd = {}, lrCL = {}'.\
        ...
        title = 'AUC Gemcitabine iter = {}, fold = {}, mb_size = {},  h_dim = {}, lrE = {}, epoch = {}, rate = {}, wd = {}, lrCL = {}'.\
                      format(iters, k, mbs, hdm, lre, epch, rate, wd, lrCL)        
