...
save_results_to = '/home/hnoghabi/EarlyIntegrationv5/Paclitaxel/'
...
PDXM = pd.read_csv("PDX_mutations.Paclitaxelv2.tsv", 
                   sep = "\t", index_col=0, decimal = ".")
PDXM = pd.DataFrame.transpose(PDXM)

PDXC = pd.read_csv("PDX_CNA.Paclitaxelv2.tsv", 
                   sep = "\t", index_col=0, decimal = ".")
...
for iters in range(max_iter):
    ...
    for train_index, test_index in skf.split(GDSCE.values, Y):
        ...
        title = 'Cost Paclitaxel iter = {}, fold = {}, mb_size = {},  h_dim = {}, z_dim = {}, lrE =  {}, epoch = {}'.\
