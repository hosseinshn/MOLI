...
save_results_to = '/home/hnoghabi/EarlyClassNetv6/Paclitaxel/'
...
for iters in range(max_iter):
    ...
    for train_index, test_index in skf.split(GDSCE.values, Y):
        ...
        AutoencoderE = torch.load('EarlyPacPDXv5.pt')
        ...
        title = 'Cost Paclitaxel iter = {}, fold = {}, mb_size = {},  z_dim = {}, epoch = {}, rate = {}, wd = {}, lrCL = {}'.\
        ...
        title = 'AUC Paclitaxel iter = {}, fold = {}, mb_size = {},  z_dim = {}, epoch = {}, rate = {}, wd = {}, lrCL = {}'.\
                      format(iters, k, mbs, z_dim, epch, rate, wd, lrCL)        
