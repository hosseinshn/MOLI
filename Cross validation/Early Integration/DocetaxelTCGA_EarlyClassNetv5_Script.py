...
save_results_to = '/home/hnoghabi/EarlyClassNetv5/Docetaxel/'
...
for iters in range(max_iter):
    ...
    for train_index, test_index in skf.split(GDSCE.values, Y):
        ...
        AutoencoderE = torch.load('EarlyDocTCGAv4.pt')
        ...
        title = 'Cost Docetaxel iter = {}, fold = {}, mb_size = {},  z_dim = {}, epoch = {}, rate = {}, wd = {}, lrCL = {}'.\
        ...
        title = 'AUC Docetaxel iter = {}, fold = {}, mb_size = {},  z_dim = {}, epoch = {}, rate = {}, wd = {}, lrCL = {}'.\
                      format(iters, k, mbs, z_dim, epch, rate, wd, lrCL)        
