...
save_results_to = '/home/hnoghabi/EarlyClassNetv5/Cisplatin/'
...
GDSCM = pd.read_csv("GDSC_mutations.Cisplatinv2.tsv", 
                    sep = "\t", index_col=0, decimal = ".")
...
GDSCR = pd.read_csv("GDSC_response.Cisplatinv2.tsv", 
                    sep = "\t", index_col=0, decimal = ",")
...
for iters in range(max_iter):
    ...
    for train_index, test_index in skf.split(GDSCE.values, Y):
        ...
        AutoencoderE = torch.load('EarlyCisTCGAv4.pt')
        ...
        title = 'Cost Cisplatin iter = {}, fold = {}, mb_size = {},  z_dim = {}, epoch = {}, rate = {}, wd = {}, lrCL = {}'.\
        ...
        title = 'AUC Cisplatin iter = {}, fold = {}, mb_size = {},  z_dim = {}, epoch = {}, rate = {}, wd = {}, lrCL = {}'.\
                      format(iters, k, mbs, z_dim, epch, rate, wd, lrCL)        
