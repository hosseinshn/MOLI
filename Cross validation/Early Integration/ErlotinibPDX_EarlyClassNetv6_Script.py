...
save_results_to = '/home/hnoghabi/EarlyClassNetv6/Erlotinib/'
...
PDXM = pd.read_csv("PDX_mutations.Erlotinib.tsv", 
                   sep = "\t", index_col=0, decimal = ",")
...
for iters in range(max_iter):
    ...
    for train_index, test_index in skf.split(GDSCE.values, Y):
        ...
        AutoencoderE = torch.load('EarlyErloPDXv5.pt')
        ...
        title = 'Cost Erlotinib iter = {}, fold = {}, mb_size = {},  z_dim = {}, epoch = {}, rate = {}, wd = {}, lrCL = {}'.\
        ...
        title = 'AUC Erlotinib iter = {}, fold = {}, mb_size = {},  z_dim = {}, epoch = {}, rate = {}, wd = {}, lrCL = {}'.\
                      format(iters, k, mbs, z_dim, epch, rate, wd, lrCL)        
